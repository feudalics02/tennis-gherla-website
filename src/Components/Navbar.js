                            ...
                            <div className='flex space-x-4 lg:space-x-8 font-sans font-medium text-gray-700'>
                                {menuItems.map((item, index) => (
                                    <div key={index} className='relative group'>
                                        ...
                                        {item.subItems && (
                                            <div
                                                className='absolute left-0 mt-2 w-56 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none opacity-0 group-hover:opacity-100 transition-opacity duration-200'>
                                                <div className='py-1'>
                                        ...
                                        <div
                                            className={`absolute bottom-0 left-1/2 h-0.5 bg-primary transition-all duration-300 ${
                                                props.selected === index
