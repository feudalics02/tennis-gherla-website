    ...
    return (
        <nav className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-sm shadow-lg">
            ...
            <div className="bg-gradient-to-r from-primary to-secondary">
                <div
                    className="container mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between text-white">
            ...
            <div className="w-full mx-0 px-0 relative z-10 bg-white/95 backdrop-blur-sm rounded-sm">
                <div className="flex items-center h-20 gap-8 bg-white/95 justify-center">
                    ...
                    {/* Desktop navigation */}
                    <div
                        className="flex-1 flex max-md:hidden justify-center items-center space-x-8 px-6 py-2 rounded-full mx-8">
                        {navigation.map((item) => (
                            <Link
                                key={item.id}
                                to={item.href}
                        ...
                        <a
                            href="tel:0743086789"
                            className="bg-primary text-white px-8 py-3 rounded-full hover:bg-secondary transition-colors duration-300 font-semibold text-lg shadow-lg hover:shadow-xl">
                            Rezervă
                        </a>
                    </div>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden bg-white">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <a
                            href="tel:0743086789"
                            className="w-full bg-primary text-white px-6 py-2 rounded-md hover:bg-secondary transition-colors duration-300 text-center">
                            Rezervă
                        </a>
                    </div>
                </div>
